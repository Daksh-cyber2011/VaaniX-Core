...
| D4 | Class 10 Hindi A/B publish the exclusion list (छूट पाठ) but not full chapter lists. | The supplied NCERT 2026–27 textbook packages are the prescribed-content authority: Hindi A exposes 12 क्षितिज + 3 कृतिका in-scope chapters; Hindi B exposes 14 स्पर्श + 3 संचयन in-scope chapters. The official CBSE exclusions remain represented and are never selectable. No textbook prose was copied. | Canonical book chapter records + literature scope |
