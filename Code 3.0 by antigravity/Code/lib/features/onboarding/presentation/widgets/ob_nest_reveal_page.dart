...
/// Van says: "This is where we'll study together."
/// User taps "Let's Start!" to complete onboarding and go to Home.
...
class _ObNestRevealPageState extends ConsumerState<ObNestRevealPage>
  ...
  void initState() {
    ...
    // Sequence: nest reveals first, then Van slides up
          ...
          child: Padding(
            ...
            child: ScaleTransition(
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    // Nest decorations (books, plants emoji as placeholders)
                    Positioned(
                      top: 20,
                      left: 20,
...
/// Animated nest decoration element
